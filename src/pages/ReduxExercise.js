...
const ProductOne = (props) => {
  ...
  const product1 = useSelector((state) => state.product[0]);
...
const ProductTwo = (props) => {
  ...
  // You should see the price is updated
  const product2 = useSelector((state) => state.product[1]);
  // Step 9
...
const CartProductOne = (props) => {
  ...
  const cartProduct1 = useSelector((state) => state.cart.products[0]);
  console.log("cartProduct1", cartProduct1);
      ...
      <Container fluid>
        <Box>
          <Typography p="0.5rem" variant="h6">
            Quantity: {cartProduct1.qty}
          </Typography>
          <Typography p="0.5rem" variant="h6">
            Price: 💵 {cartProduct1.price}
          </Typography>
        </Box>
      </Container>
    </WrapperBox>
...
const CartProductTwo = (props) => {
  ...
  // Change the price of products in `cart.reducer.js` to see the effect
  const cartProduct2 = useSelector((state) => state.cart.products[1]);
  ...
  return (
    <WrapperBox>
      ...
      <Box>
        <Typography p="0.5rem" variant="h6">
          Quantity: {cartProduct2.qty}
        </Typography>
        <Typography p="0.5rem" variant="h6">
          Price: 💵 {cartProduct2.price}
        </Typography>
      </Box>
    </WrapperBox>
  );
